...
def main():
    ...
    if 'recommendation_engine' not in st.session_state:
        st.session_state.recommendation_engine = RecommendationEngine(st.session_state.youtube_recommender)
    ...
    with tab2:
        ...
        if users:
            ...
            st.warning("No known users. Please go to the Face Detection tab and add faces first.")
